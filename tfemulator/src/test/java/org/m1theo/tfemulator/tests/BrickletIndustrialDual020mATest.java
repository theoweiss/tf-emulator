...
public class BrickletIndustrialDual020mATest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletIndustrialDual020mA device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletIndustrialDual020mA").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletIndustrialDual020mA(uid, ipcon);
  }
  ...
  public void testgetCurrent(TestContext context) {
    try {
      int value = device.getCurrent((short) 1);
