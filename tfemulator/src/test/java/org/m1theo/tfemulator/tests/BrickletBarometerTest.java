...
public class BrickletBarometerTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletBarometer device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletBarometer").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletBarometer(uid, ipcon);
  }
  ...
  @Test
  public void testgetAirPressure(TestContext context) {
    try {
      int value = device.getAirPressure();
      context.assertEquals(Utils.getRandomInt(), value);
