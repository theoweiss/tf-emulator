...
public class BrickletDistanceUSTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletDistanceUS device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletDistanceUS").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletDistanceUS(uid, ipcon);
  }
  ...
  @Test
  public void testgetDistanceValue(TestContext context) {
    try {
      int value = device.getDistanceValue();
