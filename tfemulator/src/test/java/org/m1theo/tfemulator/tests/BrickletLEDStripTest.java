...
public class BrickletLEDStripTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletLEDStrip device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletLEDStrip").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletLEDStrip(uid, ipcon);
  }
  ...
  @Test
  public void testgetSupplyVoltage(TestContext context) {
    try {
      int value = device.getSupplyVoltage();
