...
public class BrickletCO2Test {
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletCO2").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletCO2(uid, ipcon);
  }
  ...
  @Test
  public void testgetCO2Concentration(TestContext context) {
    try {
      int value = device.getCO2Concentration();
