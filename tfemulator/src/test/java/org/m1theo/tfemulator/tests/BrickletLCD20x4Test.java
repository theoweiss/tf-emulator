...
public class BrickletLCD20x4Test {

  Vertx vertx;
  IPConnection ipcon;
  BrickletLCD20x4 device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletLCD20x4").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletLCD20x4(uid, ipcon);
  }
