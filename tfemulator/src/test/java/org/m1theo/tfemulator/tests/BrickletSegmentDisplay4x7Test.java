...
public class BrickletSegmentDisplay4x7Test {

  Vertx vertx;
  IPConnection ipcon;
  BrickletSegmentDisplay4x7 device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletSegmentDisplay4x7").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletSegmentDisplay4x7(uid, ipcon);
  }
  ...
  @Test
  public void testgetCounterValue(TestContext context) {
    try {
      int value = device.getCounterValue();
