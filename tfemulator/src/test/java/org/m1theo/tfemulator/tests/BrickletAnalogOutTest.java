...
public class BrickletAnalogOutTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletAnalogOut device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletAnalogOut").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletAnalogOut(uid, ipcon);
  }
