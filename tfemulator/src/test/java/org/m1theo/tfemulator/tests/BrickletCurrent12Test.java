...
public class BrickletCurrent12Test {

  Vertx vertx;
  IPConnection ipcon;
  BrickletCurrent12 device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletCurrent12").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletCurrent12(uid, ipcon);
  }
