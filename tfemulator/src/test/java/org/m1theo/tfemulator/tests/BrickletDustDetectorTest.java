...
public class BrickletDustDetectorTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletDustDetector device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletDustDetector").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletDustDetector(uid, ipcon);
  }
  ...
  @Test
  public void testgetDustDensity(TestContext context) {
    try {
      int value = device.getDustDensity();
