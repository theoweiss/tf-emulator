...
public class BrickletAnalogInTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletAnalogIn device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletAnalogIn").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletAnalogIn(uid, ipcon);
  }
