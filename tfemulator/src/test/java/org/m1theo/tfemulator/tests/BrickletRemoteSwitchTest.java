...
public class BrickletRemoteSwitchTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletRemoteSwitch device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletRemoteSwitch").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletRemoteSwitch(uid, ipcon);
  }
  ...
  @Test
  public void testgetSwitchingState(TestContext context) {
    try {
      short value = device.getSwitchingState();
