...
public class BrickletLoadCellTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletLoadCell device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletLoadCell").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletLoadCell(uid, ipcon);
  }
  ...
  @Test
  public void testgetWeight(TestContext context) {
    try {
      int value = device.getWeight();
