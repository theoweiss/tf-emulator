...
public class BrickletOLED128x64Test {

  Vertx vertx;
  IPConnection ipcon;
  BrickletOLED128x64 device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletOLED128x64").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletOLED128x64(uid, ipcon);
  }
