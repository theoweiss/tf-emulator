...
public class BrickletSolidStateRelayTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletSolidStateRelay device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletSolidStateRelay").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletSolidStateRelay(uid, ipcon);
  }
