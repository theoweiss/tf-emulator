...
public class BrickletIndustrialDigitalIn4Test {

  Vertx vertx;
  IPConnection ipcon;
  BrickletIndustrialDigitalIn4 device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletIndustrialDigitalIn4").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletIndustrialDigitalIn4(uid, ipcon);
  }
  ...
  @Test
  public void testgetAvailableForGroup(TestContext context) {
    try {
      short value = device.getAvailableForGroup();
