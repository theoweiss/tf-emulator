...
public class BrickletLinearPotiTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletLinearPoti device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletLinearPoti").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletLinearPoti(uid, ipcon);
  }
