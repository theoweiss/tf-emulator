...
public class BrickletDualRelayTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletDualRelay device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletDualRelay").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletDualRelay(uid, ipcon);
  }
