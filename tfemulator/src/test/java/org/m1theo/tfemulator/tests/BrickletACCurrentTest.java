...
import com.tinkerforge.BrickletACCurrent;
...
public class BrickletACCurrentTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletACCurrent device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletACCurrent").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletACCurrent(uid, ipcon);
  }
  ...
  public void testgetAnalogValue(TestContext context) {
    try {
      int value = device.getAnalogValue();
