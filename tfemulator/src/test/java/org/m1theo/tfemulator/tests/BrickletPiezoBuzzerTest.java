...
public class BrickletPiezoBuzzerTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletPiezoBuzzer device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletPiezoBuzzer").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletPiezoBuzzer(uid, ipcon);
  }
