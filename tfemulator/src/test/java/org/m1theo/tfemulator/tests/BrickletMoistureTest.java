...
public class BrickletMoistureTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletMoisture device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletMoisture").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletMoisture(uid, ipcon);
  }
  ...
  @Test
  public void testgetMoistureValue(TestContext context) {
    try {
      int value = device.getMoistureValue();
