...
public class BrickletMotionDetectorTest {
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletMotionDetector").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletMotionDetector(uid, ipcon);
  }
  ...
  @Test
  public void testgetMotionDetected(TestContext context) {
    try {
      short value = device.getMotionDetected();
