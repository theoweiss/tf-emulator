...
public class BrickletOLED64x48Test {

  Vertx vertx;
  IPConnection ipcon;
  BrickletOLED64x48 device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletOLED64x48").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletOLED64x48(uid, ipcon);
  }
