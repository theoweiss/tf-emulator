...
public class BrickletMultiTouchTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletMultiTouch device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletMultiTouch").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletMultiTouch(uid, ipcon);
  }
  ...
  @Test
  public void testgetTouchState(TestContext context) {
    try {
      int value = device.getTouchState();
