...
public class BrickletCurrent25Test {

  Vertx vertx;
  IPConnection ipcon;
  BrickletCurrent25 device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletCurrent25").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletCurrent25(uid, ipcon);
  }
