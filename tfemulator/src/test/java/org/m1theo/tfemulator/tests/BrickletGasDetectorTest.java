...
import com.tinkerforge.BrickletGasDetector;
...
public class BrickletGasDetectorTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletGasDetector device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletGasDetector").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletGasDetector(uid, ipcon);
  }
