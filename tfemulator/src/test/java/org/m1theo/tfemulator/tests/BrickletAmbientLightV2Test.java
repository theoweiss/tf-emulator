...
public class BrickletAmbientLightV2Test {

  Vertx vertx;
  IPConnection ipcon;
  BrickletAmbientLightV2 device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletAmbientLightV2").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletAmbientLightV2(uid, ipcon);
  }
