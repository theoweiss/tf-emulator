...
public class BrickletVoltageTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletVoltage device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletVoltage").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletVoltage(uid, ipcon);
  }
