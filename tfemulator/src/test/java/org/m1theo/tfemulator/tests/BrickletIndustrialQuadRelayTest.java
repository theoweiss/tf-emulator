...
public class BrickletIndustrialQuadRelayTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletIndustrialQuadRelay device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletIndustrialQuadRelay").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletIndustrialQuadRelay(uid, ipcon);
  }
