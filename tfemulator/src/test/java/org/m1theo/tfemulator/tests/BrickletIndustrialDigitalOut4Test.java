...
public class BrickletIndustrialDigitalOut4Test {

  Vertx vertx;
  IPConnection ipcon;
  BrickletIndustrialDigitalOut4 device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletIndustrialDigitalOut4").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletIndustrialDigitalOut4(uid, ipcon);
  }
