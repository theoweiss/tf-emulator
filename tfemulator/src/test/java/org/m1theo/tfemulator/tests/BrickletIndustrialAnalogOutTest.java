...
public class BrickletIndustrialAnalogOutTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletIndustrialAnalogOut device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletIndustrialAnalogOut").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletIndustrialAnalogOut(uid, ipcon);
  }
