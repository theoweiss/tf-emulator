...
public class BrickletLineTest {
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletLine").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletLine(uid, ipcon);
  }
  ...
  @Test
  public void testgetReflectivity(TestContext context) {
    try {
      int value = device.getReflectivity();
