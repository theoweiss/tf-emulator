...
public class BrickletOzoneTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletOzone device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletOzone").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletOzone(uid, ipcon);
  }
  ...
  @Test
  public void testgetOzoneConcentration(TestContext context) {
    try {
      int value = device.getOzoneConcentration();
      context.assertEquals(Utils.getRandomInt(), value);
