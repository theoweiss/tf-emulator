...
public class BrickletRotaryPotiTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletRotaryPoti device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletRotaryPoti").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletRotaryPoti(uid, ipcon);
  }
  ...
  public void testgetPosition(TestContext context) {
    try {
      short value = device.getPosition();
