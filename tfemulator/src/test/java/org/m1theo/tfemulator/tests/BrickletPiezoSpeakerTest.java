...
public class BrickletPiezoSpeakerTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletPiezoSpeaker device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletPiezoSpeaker").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletPiezoSpeaker(uid, ipcon);
  }
