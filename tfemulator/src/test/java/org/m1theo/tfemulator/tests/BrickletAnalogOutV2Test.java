...
public class BrickletAnalogOutV2Test {

  Vertx vertx;
  IPConnection ipcon;
  BrickletAnalogOutV2 device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletAnalogOutV2").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletAnalogOutV2(uid, ipcon);
  }
  ...
  @Test
  public void testgetInputVoltage(TestContext context) {
    try {
      int value = device.getInputVoltage();
