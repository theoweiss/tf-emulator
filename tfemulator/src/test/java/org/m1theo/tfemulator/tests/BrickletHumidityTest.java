...
public class BrickletHumidityTest {
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletHumidity").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletHumidity(uid, ipcon);
  }
  ...
  @Test
  public void testgetHumidity(TestContext context) {
    try {
      int value = device.getHumidity();
