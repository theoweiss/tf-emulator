...
public class BrickletSoundIntensityTest {
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletSoundIntensity").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletSoundIntensity(uid, ipcon);
  }
  ...
  @Test
  public void testgetIntensity(TestContext context) {
    try {
      int value = device.getIntensity();
