...
public class BrickletLaserRangeFinderTest {

  Vertx vertx;
  IPConnection ipcon;
  BrickletLaserRangeFinder device;
  ...
  public void before(TestContext context) {
    ...
    JsonObject emuconfig = new JsonObject().put("devices", new JsonArray().add(
        new JsonObject().put("type", "BrickletLaserRangeFinder").put("uid", uid).put("enabled", true)));
    ...
    device = new BrickletLaserRangeFinder(uid, ipcon);
  }
  ...
  @Test
  public void testgetVelocity(TestContext context) {
    try {
      short value = device.getVelocity();
  ...
  @Test
  public void testgetDistance(TestContext context) {
    try {
      int value = device.getDistance();
  ...
  @Test
  public void testLaser(TestContext context) {
    try {
      device.setResponseExpectedAll(true);
      device.enableLaser(); //enable
      //assert enabled
      boolean value = device.isLaserEnabled();
context.assertTrue(value);

      device.disableLaser(); //disable
      // assert disabled
      value = device.isLaserEnabled();
