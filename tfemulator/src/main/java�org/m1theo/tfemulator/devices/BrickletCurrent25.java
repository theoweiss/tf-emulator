 ...
 */
public class BrickletCurrent25 extends AbstractVerticle {
long uidBytes;
...
public final static String DEVICE_DISPLAY_NAME = "Current25 Bricklet";
  ...
  public void start() throws Exception {
    ...
    logger.info("Verticle started: " + BrickletCurrent25.class);
...
//fixme getter callback without sensor analogValueReached
  ...
  private Buffer getIsOverCurrentBuffer(byte functionId, byte options) {
    ...
    Buffer buffer = Buffer.buffer();
    buffer.appendBuffer(header);
    buffer.appendBytes(Utils.getUInt8(isOverCurrent));
