...
public final static String DEVICE_DISPLAY_NAME = "Master Brick";
  ...
  private Buffer stackVoltageCallbackThreshold = Utils.getThresholdDefault();
  private Buffer uSBVoltageCallbackThreshold = Utils.getThresholdDefault();
  private Buffer stackCurrentCallbackThreshold = Utils.getThresholdDefault();
