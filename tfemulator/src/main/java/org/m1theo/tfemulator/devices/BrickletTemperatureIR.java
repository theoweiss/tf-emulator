...
public final static String DEVICE_DISPLAY_NAME = "Temperature IR Bricklet";
  ...
  private Buffer ambientTemperatureCallbackThreshold = Utils.getThresholdDefault();
  private Buffer objectTemperatureCallbackThreshold = Utils.getThresholdDefault();
